# [Creating a Rails API from Scratch](https://learn.co/tracks/online-software-engineering-structured/front-end-web-programming/rails-as-an-api/creating-a-rails-api-from-scratch)
...
application should be API-only.
