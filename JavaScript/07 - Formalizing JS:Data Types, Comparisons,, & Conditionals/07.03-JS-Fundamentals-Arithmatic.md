# [JS Fundamentals - Arithmetci Lab](https://learn.co/tracks/online-software-engineering-structured/front-end-web-programming/formalizing-js-data-types-comparisons-conditionals/js-fundamentals-arithmetic-lab)
...
boils down to the language, once again, trying to be too user-friendly.
...
of operations used in basic math. 
...
it to calculate the incalculable.

For example, imagine that one of the lines of
