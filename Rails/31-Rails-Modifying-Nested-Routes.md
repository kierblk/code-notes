# [Rails - Modifying Nested Resources](https://github.com/saramccombs/modification-nested-routes-reading-online-web-pt-081219)
...
Open up the post form partial and add a hidden field for the `:author_id`.
